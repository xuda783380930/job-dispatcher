...
public class Task implements Serializable{
	...
	public Task(TaskBuilder taskBuilder,String eventTime) {
		...
		this.upstreamTaskCodes = taskBuilder.getUpstreamTaskCodes().toString().replace("[", "").replace("]", "");
    ...
    public JsonObject toJsonObject(){
		...
		List<String> upstreamTaskC = this.getUpstreamTaskCodes();
	...
	public List<String> getUpstreamTaskCodes() {
		List<String> codeList = new ArrayList<String>();
		if(null!=this.upstreamTaskCodes) {
			String[] upstreamTaskCodes = this.upstreamTaskCodes.split(",");
			for(String upstreamTaskCode:upstreamTaskCodes){
				codeList.add(upstreamTaskCode);
			}
		}
		return codeList;
	}
